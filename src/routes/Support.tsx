  ...
  return (
    <Box direction="column" gap={4}>
      <div className="text-xl">
        ...
        is the easiest place to look for help…
      </div>
      <div>
        But it's often not the fastest. This project is maintained by a single
        developer so there is limited bandwidth for answering questions.
      </div>
      <div>
