  ...
  return (
    <div className="Api">
      <div className="ApiContent">
        ...
        <p>
          This component has the same props as <Link to="/api/FixedSizeGrid#props"><code>FixedSizeGrid</code></Link>, but with the following additions:
        </p>
        <dl className="ApiPropGrid">
          ...
          <dd className="ApiPropDefinition">
            ...
            The estimated width impacts user scrolling behavior.
            It is updated whenever new columns are measured.
          </dd>
          <dt className="ApiPropType">
          ...
          <dd className="ApiPropDefinition">
            ...
            The estimated height impacts user scrolling behavior.
            It is updated whenever new columns are measured.
          </dd>
          <dt className="ApiPropType">
        ...
        <p>
          This component has the same methods as <Link to="/api/FixedSizeGrid#methods"><code>FixedSizeGrid</code></Link>, but with the following additions:
        </p>
        <dl>
          <dt className="ApiPropType">
          ...
          <dd className="ApiPropDefinition">
            <code>DynamicGrid</code> caches offsets and measurements for each column index for performance purposes.
            This method clears that cached data for all columns after (and including) the specified index.
            It should be called whenever a column's width changes.
        ...
        <dl>
          ...
          <dd className="ApiPropDefinition">
            <code>DynamicGrid</code> caches offsets and measurements for each row index for performance purposes.
            This method clears that cached data for all rows after (and including) the specified index.
            It should be called whenever a row's height changes.
            (Note that this is not a typical occurrance.)
          </dd>
        </dl>
      </div>
