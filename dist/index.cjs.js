...
var getEstimatedTotalHeight = function getEstimatedTotalHeight(props, instanceProps) {
  var itemMetadata = getItemMetadata('row', props, props.rowCount - 1, instanceProps);
  return itemMetadata.offset + itemMetadata.size;
};

var getEstimatedTotalWidth = function getEstimatedTotalWidth(props, instanceProps) {
  var itemMetadata = getItemMetadata('column', props, props.columnCount - 1, instanceProps);
  return itemMetadata.offset + itemMetadata.size;
};
...
var VariableSizeGrid = /*#__PURE__*/createGridComponent({
  ...
  initInstanceProps: function initInstanceProps(props, instance) {
    var _ref = props,
        estimatedColumnWidth = _ref.estimatedColumnWidth,
    ...
    instance.resetAfterIndices = function (_ref2) {
  ...
  validateProps: function validateProps(_ref3) {
    var columnWidth = _ref3.columnWidth,
