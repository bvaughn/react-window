...
import styles from './MobileGitHubButton.module.css';

export const MobileGitHubButton = () => (
  <a
    ...
    <svg className={styles.MobileGitHubButtonIcon} viewBox="0 0 24 24">
      ...
      <path
        d="
        	...
        	1.096.81 2.22 0 1.606-.015 2.896-.015 3.286 0 .315.21.69.825.57C20.565 22.092 24
        	17.592 24 12.297c0-6.627-5.373-12-12-12
        "
        className={styles.MobileGitHubButtonIconPath}
      />
    </svg>
  </a>
);
