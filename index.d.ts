declare module 'react-window' {
    ...
    type Align = 'auto' | 'center' | 'end' | 'start';
    ...
    interface GridProps extends CommonProps {
         ...
         */
        itemKey?: (params: { columnIndex: number; rowIndex: number }) => Key;
        /**
    ...
    export class FixedSizeList extends Component<FixedSizeListProps> {
         ...
         */
        public scrollToItem(index: number, align?: Align): void;
    }
    ...
    export class VariableSizeList extends Component<VariableSizeListProps> {
         ...
         */
        public resetAfterIndex(index: number, shouldForceUpdate: boolean): void;
    }
    ...
    export class FixedSizeGrid extends Component<FixedSizeGridProps> {
         ...
         */
        public scrollTo(params: { scrollLeft: number; scrollTop: number }): void;
        /**
         * Scroll to the specified item.
         * 
         * By default, the Grid will scroll as little as possible to ensure the item is visible. You can control the alignment of the item though by specifying a second alignment parameter. Acceptable values are:
         * 
         * - auto (default) - Scroll as little as possible to ensure the item is visible. (If the item is already visible, it won't scroll at all.)
         ...
         */
        public scrollToItem(params: { align?: Align; columnIndex: number; rowIndex: number; }): void;
    }
    ...
    export class VariableSizeGrid extends Component<VariableSizeGridProps> {
         ...
         */
        public resetAfterColumnIndex(index: number, shouldForceUpdate?: boolean): void
        /**
         ...
         * 
         * By default the grid will automatically re-render after the index is reset. If you would like to delay this re-render until e.g. a state update has completed in the parent component, specify a value offalse for the optional shouldForceUpdate parameter.
         */
        public resetAfterIndices(params: { columnIndex: number; rowIndex: number; shouldForceUpdate?: boolean }): void
        /**
